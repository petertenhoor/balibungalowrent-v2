...
class EddLicenseApi
{
    const KEY_OPTION = 'mphb_mc_edd_license_key';
    const STATUS_OPTION = 'mphb_mc_edd_license_status';

    const PRODUCT_ID = 869188;
    ...
    public function request($eddAction)
    {
        ...
        $requestUrl = add_query_arg($requestArgs, mphbmc()->pluginUri());

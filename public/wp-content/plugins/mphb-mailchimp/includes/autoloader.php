...
spl_autoload_register(function ($className) {
    ...
    $vendors = [
        ...
        'DrewM\MailChimp\MailChimp' => 'vendors/mailchimp-api/src/MailChimp.php',
        'DrewM\MailChimp\Batch'     => 'vendors/mailchimp-api/src/Batch.php',
        'NSCL\WordPress\Async\BackgroundProcess' => 'vendors/wp-background-process/background-process.php'
    ];
